...
CREATE TABLE IF NOT EXISTS datasets (
  ...
  created_by TEXT NOT NULL DEFAULT 'shesl-meow',
  updated_by TEXT NOT NULL DEFAULT 'shesl-meow',
...
INSERT INTO snapshot_presets (preset_key, name, payload) VALUES ('web_default', 'Web 浏览器环境', '{"platform":"web","browser":"chromium","network":"online","locale":"zh-CN"}'::jsonb)
ON CONFLICT (preset_key) DO UPDATE SET name = EXCLUDED.name, payload = EXCLUDED.payload;

INSERT INTO snapshot_presets (preset_key, name, payload) VALUES ('repo_node', '代码仓库环境', '{"platform":"repo","os":"ubuntu-22.04","runtime":"node18","tools":["git","npm"]}'::jsonb)
ON CONFLICT (preset_key) DO UPDATE SET name = EXCLUDED.name, payload = EXCLUDED.payload;

INSERT INTO snapshot_presets (preset_key, name, payload) VALUES ('ubuntu_terminal', 'Ubuntu 终端环境', '{"platform":"ubuntu","version":"22.04","shell":"bash","network":"restricted"}'::jsonb)
ON CONFLICT (preset_key) DO UPDATE SET name = EXCLUDED.name, payload = EXCLUDED.payload;
